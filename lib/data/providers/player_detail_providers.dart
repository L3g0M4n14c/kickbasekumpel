...
final playerDetailsProvider = FutureProvider.family<Map<String, dynamic>, ({String leagueId, String playerId})>((
  ref,
  params,
) async {
...
final playerMarketValueProvider = FutureProvider.family<Map<String, dynamic>, ({String leagueId, String playerId, int timeframe})>((
  ref,
  params,
) async {
  final apiClient = ref.watch(kickbaseApiClientProvider);
...
final playerMarketValueYearProvider = FutureProvider.family<Map<String, dynamic>, ({String leagueId, String playerId})>((
  ref,
  params,
) async {
  final apiClient = ref.watch(kickbaseApiClientProvider);
...
final playerTransferHistoryProvider = FutureProvider.family<Map<String, dynamic>, ({String leagueId, String playerId, int? matchDay})>((
  ref,
  params,
) async {
  final apiClient = ref.watch(kickbaseApiClientProvider);
...
final currentPlayerTransferHistoryProvider = FutureProvider.family<Map<String, dynamic>, ({String leagueId, String playerId})>((
  ref,
  params,
) async {
  final apiClient = ref.watch(kickbaseApiClientProvider);
...
final playerTransfersProvider = FutureProvider.family<Map<String, dynamic>, ({String leagueId, String playerId})>((
  ref,
  params,
) async {
  final apiClient = ref.watch(kickbaseApiClientProvider);
  return await apiClient.getPlayerTransfers(params.leagueId, params.playerId);
});
